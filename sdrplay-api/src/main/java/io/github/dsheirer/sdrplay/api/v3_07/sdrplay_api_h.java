...
public class sdrplay_api_h  {
    ...
    public static int sdrplay_api_Open () {
        var mh$ = RuntimeHelper.requireNonNull(constants$7.sdrplay_api_Open$MH, "sdrplay_api_Open");
        try {
    ...
    public static int sdrplay_api_Close () {
        var mh$ = RuntimeHelper.requireNonNull(constants$7.sdrplay_api_Close$MH, "sdrplay_api_Close");
        try {
            return (int)mh$.invokeExact();
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static int sdrplay_api_LockDeviceApi () {
        var mh$ = RuntimeHelper.requireNonNull(constants$7.sdrplay_api_LockDeviceApi$MH, "sdrplay_api_LockDeviceApi");
        try {
            return (int)mh$.invokeExact();
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static int sdrplay_api_UnlockDeviceApi () {
        var mh$ = RuntimeHelper.requireNonNull(constants$7.sdrplay_api_UnlockDeviceApi$MH, "sdrplay_api_UnlockDeviceApi");
        try {
            return (int)mh$.invokeExact();
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static MemoryAddress sdrplay_api_GetErrorString ( int err) {
        var mh$ = RuntimeHelper.requireNonNull(constants$8.sdrplay_api_GetErrorString$MH, "sdrplay_api_GetErrorString");
        try {
    ...
    public static int sdrplay_api_DisableHeartbeat () {
        var mh$ = RuntimeHelper.requireNonNull(constants$8.sdrplay_api_DisableHeartbeat$MH, "sdrplay_api_DisableHeartbeat");
        try {
            return (int)mh$.invokeExact();
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
