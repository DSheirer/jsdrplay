...
public class sdrplay_api_DeviceT {
    ...
    public static MemoryAddress dev$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)sdrplay_api_DeviceT.dev$VH.get(seg);
    }
    ...
    public static MemoryAddress dev$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)sdrplay_api_DeviceT.dev$VH.get(seg.asSlice(index*sizeof()));
    }
